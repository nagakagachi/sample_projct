...
#if 0
bbv_removal_carving_indirect_arg_build_cs.hlsl

BBV RemovalのFrustum ActiveListからCarving用DispatchIndirect引数を生成する。
#endif
    ...
    uint gindex : SV_GroupIndex)
{
    ...
    // bbv_removal_carving_cs.hlsl は 1 thread = 1 u32 block を処理する。
    ...
    RWFrustumBrickIndirectArg[0] = (total_u32_jobs + (k_bbv_removal_carving_thread_group_size - 1)) / k_bbv_removal_carving_thread_group_size;
