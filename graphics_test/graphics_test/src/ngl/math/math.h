...
namespace ngl
{
	namespace math
	{
		...
		// Mat * scalar
		inline constexpr Mat22 operator*(const Mat22& m0, float s)
		{
			return Mat22(
				m0.r0 * s,
				m0.r1 * s
		...
		// scalar * Mat
		inline constexpr Mat22 operator*(float s, const Mat22& m0)
		{
			return m0 * s;
		}
		// Mat / scalar
		...
		// Mat * scalar
		inline constexpr Mat33 operator*(const Mat33& m0, float s)
		{
			return Mat33(
				m0.r0 * s,
				m0.r1 * s,
		...
		// scalar * Mat
		inline constexpr Mat33 operator*(float s, const Mat33& m0)
		{
			return m0 * s;
		}
		// Mat / scalar
		...
		// Mat * scalar
		inline constexpr Mat44 operator*(const Mat44& m0, float s)
		{
			return Mat44(
				m0.r0 * s,
				m0.r1 * s,
		...
		// scalar * Mat
		inline constexpr Mat44 operator*(float s, const Mat44& m0)
		{
			return m0 * s;
		}
		// Mat / scalar
